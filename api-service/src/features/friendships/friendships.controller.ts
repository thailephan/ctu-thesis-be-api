...
module.exports = (app: Express) => {
    app.get("/friendships/get_list", filterGetList, async (req, res) => {
        ...
        debug.debugger(`/friendships/get_list query`, JSON.stringify({size, page, search, sort, offset, limit}));
        ...
        try {
            ...
            debug.debugger(`/friendships/get_list success`, JSON.stringify({size, page, search, sort, totalPage}));
    ...
    app.get("/friendships/get_by_user_id/:id", async (req, res) => {
        ...
        try {
            ...
            debug.debugger(`/friendships/${id} result`, JSON.stringify(user));
            if (!user) {
            ...
            debug.debugger(`/friendships/${id} error`, e.message);
            return res.status(400).json({
                success: false,
                statusCode: 400,
    ...
    app.post("/friendships/create", async (req, res) => {
        ...
        try {
            ...
            debug.debugger("/friendships/create success", result);
            ...
            debug.debugger("/friendships/create error", e.message);
            res.status(400).json({
                statusCode: 400,
                success: false,
                errorMessage: e.message,
    ...
    // app.put("/friendships/updateById", async (req, res) => {
    ...
    //         debug.debugger("/friendships/create success", result_id);
    //         return res.status(201).json({
    //             success: true,
    //             data: {
    //                 id: result_id
