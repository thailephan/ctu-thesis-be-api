...
module.exports = (app: Express) => {
    app.get("/message-types/get_list", filterGetList, async (req, res) => {
        ...
        debug.debugger(`/message-types/get_list query`, JSON.stringify({size, page, search, sort, offset, limit}));
        ...
        try {
            ...
            debug.debugger(`/message-types/get_list success`, JSON.stringify({size, page, search, sort, totalPage}));
    ...
    app.get("/message-types/get_by_id/:id", async (req, res) => {
        ...
        try {
            ...
            debug.debugger(`/message-types/${id} result`, JSON.stringify(user));
            if (!user) {
            ...
            debug.debugger(`/message-types/${id} error`, e.message);
            return res.status(400).json({
                success: false,
                statusCode: 400,
